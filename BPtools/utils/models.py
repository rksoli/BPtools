...
class VAE2D_Gauss(BPModule):
    def __init__(self, encoder, decoder):
        super(VAE2D_Gauss, self).__init__()
        self.encoder = encoder
        self.decoder = decoder
...
class GridEncoder2D_Gauss(nn.Module):
    def __init__(self, kernel=2):
        super(GridEncoder2D_Gauss, self).__init__()
...
class GridEncoder2D_Bernoulli(nn.Module):
    def __init__(self, sigmoid=True):
        super(GridEncoder2D_Bernoulli, self).__init__()
...
class GridLatentDiscriminator2D(nn.Module):
    def __init__(self):
        super(GridLatentDiscriminator2D, self).__init__()
